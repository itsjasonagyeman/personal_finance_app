...
export default function Signinbox({ setIsAuth }) {
  const handleSignIn = () => {
    // TODO: validate credentials here before setting auth
    setIsAuth(true);
  };
  return (
    <div className='signinbox'>
        ...
        <input type='password' placeholder='Enter your password' className='passwordbox'/>
